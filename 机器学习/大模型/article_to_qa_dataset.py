...
# 提示词模板
system_prompt = f"""
你是一个用于构建问答数据集的数据标注助手，现在你将收到一段文章片段，请从文章片段中提取多个高质量的问答对，这些问答数据会用于训练一个具有世界观一致性和逻辑连贯性的大语言模型。

---

### 🧠 背景知识

以下是你即将处理的文章片段的背景知识，请将此背景知识视为真实存在的世界设定，并作为你理解当前内容的基础：
...
- 问句和答案均不得出现“文章提到”、“本篇写道”、“作者表示”等转述类措辞；
